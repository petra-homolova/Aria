...
<div class="container-fluid bestseller-hero">
    <div class="row">
        <div class="col-md-12 justify-content-center">
            <h1 class="h1 py-5"><?php pll_e("BESTSELLERS") ?></h1>
        </div>
    </div>
</div>
                ...
                <div class="col-md-4 my-5">
                    <div class="cards" style="width: 100%; height: 100%;">
                        ...
                        if ($item_one && isset($item_one['url'])) : ?>
                            <div class="image-container" style="width: 100%; height: 350px;">
                                <img src="<?php echo esc_url($item_one['url']); ?>" class="card-img-top p-5 object-fit-cover" alt="<?php echo esc_attr($item_one['alt']); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        <?php else : ?>
                            <div class="image-container" style="width: 100%; height: 350px; background-color: #f5f5f5; object-fit-cover">
